...
const PageProduitsContent = () => {
      ...
      .then((res) => {
        let produitsFiltres = res.data.filter((p) => {
          const appartientCategorie =
            p?.categorieId === categorieIdNumber;

          const appartientSousCategorie =
            !sousCategorieIdNumber ||
            p?.sousCategorieId === sousCategorieIdNumber;

          return appartientCategorie && appartientSousCategorie;
        });
  ...
  const produitsFiltres = produits.filter((p) => {
    return (
      (!selectedMarque || p?.marqueId === Number(selectedMarque)) &&
